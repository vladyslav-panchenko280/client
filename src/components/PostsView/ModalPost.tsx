...
import { addPost } from "../../pages/api/crud/addPost";
...
export const ModalPost = () => {
  ...
  const postState = useSelector((state: RootState) => state.postValidator);
    ...
    <div>
      ...
      <Button
        ...
        onClick={async () => {
          ...
          const response = await addPost(token, postState);
          if (!response.ok) {
